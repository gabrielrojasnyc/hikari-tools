...
import { JudgeMika, TradeDecision } from './judge.js';
...
export class DebateManager {
  private bull: BullMika;
  private bear: BearMika;
  private flow: FlowMika;
  private judge: JudgeMika;
  ...
  async startDebate(
    ...
    onDecision?: (decision: TradeDecision) => Promise<void>
  ): Promise<void> {
    const debateId = uuid();
