...
export interface XAccount {
  ...
  weight: number; // Signal weight (1-10)
  tags: string[];
}

// Equity Day Trading (10 accounts)
const equityAccounts: XAccount[] = [
...
const optionsAccounts: XAccount[] = [
...
// Export all accounts
export const xAccounts: XAccount[] = [
  ...equityAccounts,
  ...optionsAccounts,
  ...cryptoAccounts,
];
...
// Helper functions
export function getAccountsByCategory(category: XAccount['category']): XAccount[] {
...
export function getWeightedHandles(): string[] {
