...
import {
  ...
  applyKillCriteriaAdjustments,
  calculateQuantity,
  calculateFullPosition,
  isValidPositionSize,
  calculateBracketPrices
} from '../agents/sora/sizing.js';
import {
  checkKillCriteria,
  emergencyStop
} from '../agents/sora/risk.js';
...
describe('Position Sizing', () => {
  ...
  describe('applyKillCriteriaAdjustments', () => {
    it('should reduce size by 50% when drawdown > 15%', () => {
      const result = applyKillCriteriaAdjustments(
        2000, // raw size
        20,   // 20% drawdown
  ...
  describe('calculateFullPosition', () => {
    ...
    it('should apply all kill criteria adjustments', () => {
      const result = calculateFullPosition(
        8, 4, 100,
        20,  // drawdown
