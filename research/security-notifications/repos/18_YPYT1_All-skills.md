...
**File:** `skills/openclaw-skills/ashwaq06/createos/config/config.json`
...
```bash
# Add to .gitignore
echo "skills/openclaw-skills/ashwaq06/createos/config/config.json" >> .gitignore

# Remove from git history
git rm --cached skills/openclaw-skills/ashwaq06/createos/config/config.json
