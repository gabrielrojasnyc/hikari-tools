...
**Repository:** `digitalknk/openclaw-runbook`
**File:** `examples/sanitized-config.json`
...
```bash
# Add to .gitignore
echo "examples/sanitized-config.json" >> .gitignore

# Remove from git history
git rm --cached examples/sanitized-config.json
