...
**Repository:** `Crissavino/carlitos-v2`
**File:** `infra/openclaw/openclaw.config.json`
...
```bash
# Add to .gitignore
echo "infra/openclaw/openclaw.config.json" >> .gitignore

# Remove from git history
git rm --cached infra/openclaw/openclaw.config.json
