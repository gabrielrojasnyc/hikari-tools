...
**Repository:** `GrahamMcBain/Propodcalw`
**File:** `config/hey-neighbor-config.json`
...
```bash
# Add to .gitignore
echo "config/hey-neighbor-config.json" >> .gitignore

# Remove from git history
git rm --cached config/hey-neighbor-config.json
