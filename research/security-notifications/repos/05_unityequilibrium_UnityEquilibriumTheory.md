...
**Repository:** `unityequilibrium/UnityEquilibriumTheory`
**File:** `openclaw-marketing/config/mcp_config.json`
...
```bash
# Add to .gitignore
echo "openclaw-marketing/config/mcp_config.json" >> .gitignore

# Remove from git history
git rm --cached openclaw-marketing/config/mcp_config.json
