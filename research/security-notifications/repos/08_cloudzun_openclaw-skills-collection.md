...
**Repository:** `cloudzun/openclaw-skills-collection`
**File:** `openclaw-product-tracker/config.json`
...
```bash
# Add to .gitignore
echo "openclaw-product-tracker/config.json" >> .gitignore

# Remove from git history
git rm --cached openclaw-product-tracker/config.json
