...
**File:** `public/skills/s7cret/binance-enhanced/openclaw-config.json`
...
```bash
# Add to .gitignore
echo "public/skills/s7cret/binance-enhanced/openclaw-config.json" >> .gitignore

# Remove from git history
git rm --cached public/skills/s7cret/binance-enhanced/openclaw-config.json
