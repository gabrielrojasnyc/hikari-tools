...
**Repository:** `AX-MCP/AX-CommunityWorkspaces`
**File:** `flavor-atlas/cookbooks/cookbooks/Heartland-Table/.clawdbot/mcporter-config.json`
...
```bash
# Add to .gitignore
echo "flavor-atlas/cookbooks/cookbooks/Heartland-Table/.clawdbot/mcporter-config.json" >> .gitignore

# Remove from git history
git rm --cached flavor-atlas/cookbooks/cookbooks/Heartland-Table/.clawdbot/mcporter-config.json
