...
**File:** `public/skills/ashwaq06/createos/config/config.json`
...
```bash
# Add to .gitignore
echo "public/skills/ashwaq06/createos/config/config.json" >> .gitignore

# Remove from git history
git rm --cached public/skills/ashwaq06/createos/config/config.json
