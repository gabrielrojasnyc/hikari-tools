...
**Repository:** `NodeOps-app/skills`
**File:** `skills/createos/config/config.json`
...
```bash
# Add to .gitignore
echo "skills/createos/config/config.json" >> .gitignore

# Remove from git history
git rm --cached skills/createos/config/config.json
