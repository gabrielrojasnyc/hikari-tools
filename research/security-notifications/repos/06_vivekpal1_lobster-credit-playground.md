...
**Repository:** `vivekpal1/lobster-credit-playground`
**File:** `openclaw/openclaw.config.json`
...
```bash
# Add to .gitignore
echo "openclaw/openclaw.config.json" >> .gitignore

# Remove from git history
git rm --cached openclaw/openclaw.config.json
