...
**Repository:** `explooosion/openclaw-docker`
**File:** `data/workspace/skills/weather/config.json`
...
```bash
# Add to .gitignore
echo "data/workspace/skills/weather/config.json" >> .gitignore

# Remove from git history
git rm --cached data/workspace/skills/weather/config.json
