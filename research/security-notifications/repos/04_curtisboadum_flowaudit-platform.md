...
**Repository:** `curtisboadum/flowaudit-platform`
**File:** `openclaw/gateway/config.json5`
...
```bash
# Add to .gitignore
echo "openclaw/gateway/config.json5" >> .gitignore

# Remove from git history
git rm --cached openclaw/gateway/config.json5
