import { IndexConfig, ServerConfig } from './types.js';
...
export function getIndexConfig(): IndexConfig {
  return {
    ...
    autoIndexIntervalHours: parseInt(
      process.env.AUTO_INDEX_HOURS || String(DEFAULT_INDEX_CONFIG.autoIndexIntervalHours),
      10
    ),
